...
public class AccountService {
    ...
    AccountService (AccountRepository accountRepository, AuthenticationManager authManager, JWTService jwtService){ 
    ...
    public String verify(Account account){
        Authentication authentication =
                authManager.authenticate(new UsernamePasswordAuthenticationToken(account.username(), account.password()));
